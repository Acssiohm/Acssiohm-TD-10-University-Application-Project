...
CREATE TABLE Transfers (
    id SERIAL PRIMARY KEY,
    id_issuer INTEGER NOT NULL REFERENCES Students(id),
    id_recipient INTEGER NOT NULL REFERENCES Students(id),
    amount DECIMAL NOT NULL CHECK (amount >= 0),
...
CREATE TABLE Curriculums (
    ...
    id_director INTEGER NOT NULL REFERENCES Teachers(id)
);
...
CREATE TABLE Grades (
    id_student INTEGER NOT NULL REFERENCES Students(id),
    id_validation INTEGER NOT NULL REFERENCES Validations(id),
